 ...
 public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("902247717854-2jfgcamih2net8tmo8n9b24vpuv3p0ml.apps.googleusercontent.com")
                .requestEmail()
                .build();
     ...
     public void onActivityResult(int requestCode, int resultCode, Intent data) {
         ...
         if (requestCode == REQUEST_CODE_GOOGLE) {
             ...
             try {
                 ...
                 firebaseAuthWithGoogle(account);//verificar
                    ...
                    mUserProvider.create(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(MainActivity.this, "No se almaceno la información del usuario", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
